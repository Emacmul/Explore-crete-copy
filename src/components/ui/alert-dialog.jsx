...
const AlertDialogOverlay = React.forwardRef(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    className={cn(
      // Same fix as dialog.jsx (follow-up 127) — this is the same class of shared modal
      // primitive, so pre-emptively raised to match, in case it's ever opened over a
      // Leaflet map (it isn't, today) rather than waiting for that report separately.
