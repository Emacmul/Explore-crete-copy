...
export default function UpdateAvailableToast() {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 z-[1100] max-w-md mx-auto bg-slate-900 text-white rounded-xl shadow-2xl border border-slate-700 p-4 flex flex-col gap-3 sm:flex-row sm:items-center">
      {/* Mobile-first: on a phone the icon + text get the full row and the buttons sit
          below it — squeezing them all onto one line left barely any room for the message.
          On sm+ it stays the single row it always was. */}
      <div className="flex items-center gap-3 flex-1 min-w-0">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-slate-400 break-words">Update now to get the latest fixes and features.</p>
        </div>
      </div>
